...
/**
 * Store identity and native configuration for Mergewit.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Mergewit works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  backgroundColor: '#0F1408',
  primaryColor: '#A3E635',
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.mergewit',
    buildNumber: BUILD,
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.mergewit',
