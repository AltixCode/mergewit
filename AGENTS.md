...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs mergewit`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.mergewit` |
| Scheme | `mergewit://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.mergewit.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/mergewit` |
