#!/usr/bin/env node
/**
 * Generates every brand asset for Mergewit from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.07,"y":0.07,"w":0.34,"h":0.34,"r":0.08,"fill":"accentMid"},{"type":"rect","x":0.59,"y":0.07,"w":0.34,"h":0.34,"r":0.08,"fill":"accentMid"},{"type":"poly","points":[[0.43,0.46],[0.57,0.46],[0.5,0.56]],"fill":"accentLight"},{"type":"rect","x":0.23,"y":0.58,"w":0.54,"h":0.35,"r":0.09,"fill":"accent"}];
 ...
 */
const MARK = [[1,1,0.12,0.12,0.12],[1,1,0.12,0.12,0.12],[0.12,0.12,1,1,0.12],[0.12,0.12,1,1,0.12],[0.12,0.12,0.12,0.12,0.45]];
...
console.log('Generating Mergewit brand assets\n');
