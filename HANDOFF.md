...
| CI green on a self-hosted runner | ✅ | success — run 34975872552, 2026-09-15 |
...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.mergewit` |
| App Store Connect record | ✅ | `6812380588` — store name "Mergewit" |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~9012397229` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~7840197615` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `6582956262` / `4447747511` / `6460676494`; Android `5147594821` / `7154811063` / `7736255832` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `projc6a00202`, entitlement `entl342f646d87`, offering `ofrng25d76b3114` |
